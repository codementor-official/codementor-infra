...
INSERT INTO users (id, email, handle, display_name, bio, role, email_verified_at, last_active_at) VALUES
  ...
  ('a0000000-0000-4000-8000-000000000002', 'minhanh@codementor.vn','minhanh','Nguyễn Minh Anh',    'Mentor Frontend & Thuật toán.',   'lecturer',  now(), now()),
...
INSERT INTO roadmap_courses (id, roadmap_id, course_id, position) VALUES
  -- Backend Java (mode='graph', but nothing evaluates roadmap-course edges — see 0021)
